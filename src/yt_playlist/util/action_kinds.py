...
GC_GENERATED = "gc_generated"    # an unplayed generated playlist auto-collected by the daily GC worker
...
UNDOABLE_KINDS = (PLAN, APPLY_MERGE, MOVE_IDENTITY, DELETE_EMPTY, DELETE_PLAYLIST, GC_GENERATED,
                  COPY_PLAYLIST)
